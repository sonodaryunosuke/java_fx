...
public class SevenFloorController implements Initializable{
	...
	@FXML
	private void goToSixFloor() throws IOException{
		
	//FXMLのload
		FXMLLoader loader = new FXMLLoader(getClass().getResource("Six.fxml"));
	...
	//現在のシーンを取得
		Stage stage = (Stage) button12.getScene().getWindow();
	...
	@FXML
	private Button button13;//連結するボタンはメソッドの前に置く
	@FXML
	private void goToEitoFloor() throws IOException{
		
	//FXMLのload
		FXMLLoader loader = new FXMLLoader(getClass().getResource("Eito.fxml"));
	...
	//現在のシーンを取得
		Stage stage = (Stage) button13.getScene().getWindow();
