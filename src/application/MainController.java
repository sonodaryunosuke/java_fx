...
public class MainController implements Initializable{
	...
	@FXML
	private Button button;//FXMLからButtonタグのbuttonをもってきている
	

    @FXML
    private void goToSecondFloor() throws IOException{//例外処理
    	//FXMLfillのloard
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("SecondFloor.fxml"));
    	Parent secondFloorRoot = loader.load();
    	
    	//scene make
    	Scene secondFloorScene = new Scene(secondFloorRoot,1500,800);
    	// get now stage
    	Stage stage = (Stage) button.getScene().getWindow();
    	
    	// get new window　してあたらしいwindowへ画面遷移する
    	
    	stage.setScene(secondFloorScene);
    	stage.setTitle("2階");
    	stage.show();
